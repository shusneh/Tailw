...
<div class="w-[300px] rounded-md border">
  ...
  />
  <div class="p-4" style={{backgroundColor:color, color:'blue'}}>
    <h1 class="text-lg font-semibold">About {name||"me"}</h1>
    ...
    <button
      ...
      onClick={()=>{setColor("purple");setC(color)}}
